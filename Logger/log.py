...
class Logger:
    ...
    def init(log_level='debug', dir_name='./log', file_name=None, is_log_remove=False, out_console=True, out_file=True):
        ...
        :param file_name: the file name to use for logging (default is "Logger.log")
        :param log_remove: whether to remove the existing log file on initialization (default is False)
        """
